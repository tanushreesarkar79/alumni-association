...
<html lang="en">
  ...
  <body>
    <div class="main">
      <div class="bg-img">
          <form style="left: 640px" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" name="adminlogin" method="post" class="container">
          <centre><h2>ADMIN  LOGIN </h2><br><br></centre>
          <div class="message">
            <?php 
              if($message!=""){
                echo $message;
